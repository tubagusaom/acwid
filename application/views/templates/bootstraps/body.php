    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6" data-aos="fade-up">
          ...
          <?php
            foreach ($resume_1 as $key => $res_1) {
          ?>
          <div class="resume-item">
            <h4><?=$res_1->nama?></h4>
            <h5><?=$res_1->thn_awal?> - <?=$res_1->thn_akhir?></h5>
            <p><em><?=$res_1->tempat?></em></p>
            <p><?=$res_1->description?></p>
          </div>
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          ...
          <?php
            foreach ($resume_2 as $key => $res_2) {
          ?>

          <div class="resume-item">
            <h4><?=$res_2->nama?></h4>
            <h5><?=$res_2->thn_awal?> - <?=$res_2->thn_akhir?></h5>
            <p><em><?=$res_2->tempat?></em></p>
            <p><?=$res_2->description?></p>
          </div>
  ...
  <section id="portfolio" class="portfolio section-bg">
    <div class="container">
      ...
      <div class="row" data-aos="fade-up">
        <div class="col-lg-12 d-flex justify-content-center">
          <ul id="portfolio-flters">
            ...
            <li data-filter=".filter-<?=$kat->id?>"><?=$kat->name?></li>
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
        ...
        <?php foreach ($portfolio as $keyp => $port) { ?>

          <div class="col-lg-4 col-md-6 portfolio-item filter-<?=$port->id_categories?>">
            <div class="portfolio-wrap">
              ...
              <img src="<?php echo base_url() ?>repo/portfolio/<?=$port->nama_file?>" class="img-fluid" alt="acwid">

              <div class="portfolio-links">
                <a title="<?=$port->nama_dokumen?>" href="<?php echo base_url() ?>repo/portfolio/<?=$port->nama_file?>" data-gallery="portfolioGallery" class="portfolio-lightbox">
