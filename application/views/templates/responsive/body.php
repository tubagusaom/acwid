    ...
    <?php } ?>
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 blue" href="#" style="border-radius:3px!important;">
                    <div class="visual">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 purple" href="#" style="border-radius:3px!important;">
                        <div class="visual">
