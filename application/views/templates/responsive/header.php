...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard | <?= $aplikasi->nama_unit ?></title>
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="<?= base_url() ?>" style="text-decoration: none!important;">
                          <img class="img-rounded"  src="<?= base_url() . 'assets/_tera_byte/img/favicon.png' ?>" style="padding-top:8px;" />
                        </a>
                    ...
                    <a href="javascript:;" class="menu-toggler responsive-toggler" data-toggle="collapse" data-target=".navbar-collapse">
                        <span style="color:#32c5d2!important"></span>
                    </a>
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <!-- <img alt="" class="img-circle" src="<?php echo base_url() ?>assets/_tera_byte/img/apple-touch-icon.png" /> -->
                                    <i class="icon-settings" style="font-size: 14px;"></i>
                                    <span class="username username-hide-on-mobile" style="font-size: 14px;"> <?= $this->auth->get_user_data()->nama_user ?> </span>
