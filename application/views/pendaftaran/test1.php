...
<head>
	...
	<!-- Main Style Css -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/_tera_byte/form/css/style_test1.css"/>
    ...
    <div class="grid">
      ...
      <nav class="navigation">
        <ul class="navigation__list navigation__list--inline">
          <li class="navigation__item"><a href="#" class="navigation__link navigation__link--is-active">1</a></li>
          ...
          <li class="navigation__item"><a href="#" class="navigation__link">4</a></li>
          <li class="navigation__item"><a href="#" class="navigation__link">5</a></li>
        </ul>
      </nav>
